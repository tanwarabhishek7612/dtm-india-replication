* Correlation Matrix Verification (Stata translation of the Python original)
...
* Six pairwise correlations with significance, matching scipy.stats.pearsonr
* two-tailed test used in the Python original.
...
* ---------------------------------------------------------------------------
* EXPECTED OUTPUT (from the independently-verified Python run; Table 5,
