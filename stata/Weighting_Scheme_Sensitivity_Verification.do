...
* ---------------------------------------------------------------------------
* EXPECTED OUTPUT (from the manuscript's Table 5 / Table 6, and confirmed
* by an independent Python re-implementation of this exact tie-break logic
* before this do-file was finalised):
*
