...
and `CBR_Boundary_Reversal_Verification.do`). A manual check of
`Weighting_Scheme_Sensitivity_Verification.do`'s Scheme D rho (0.859,
just outside the stated 0.86–0.87 tolerance band) is the one remaining
open item before this record is fully closed out.
